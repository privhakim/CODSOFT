...
import groceryImage from './Images/grocery-image.png';

function HeroSection() {
  return (
    <div className="container min-h-screen bg-cover bg-center px-10 py-2 relative" style={{ backgroundImage: `url(${require('./Images/ground.png')})` }}>
      <div className="text-white mt-48 max-w-xl">
        ...
        <div className="mt-10">
          ...
          <a href="#">Download App <span className="text-lg inline-block rotate-90"> &#10148;</span></a>
        </div>
      </div>
